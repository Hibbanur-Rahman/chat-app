      ...
      <div className="col-lg-8 col-12 d-flex flex-column  bg-light rounded-4 p-3  align-items-center">
        ...
        <form action="" className="col-8 mt-5">
          ...
          <div className="row m-0 p-0 mt-5">
            <button className="btn btn-ctm text-light">Log In</button>
          </div>
          <div className="row m-0 p-0 justify-content-center align-items-center mt-5">

          <p className="m-0 p-0 text-secondary text-center w-auto">Don't have an account ? </p>
          <Link to='/register' className="text-decoration-none w-auto m-0 p-0"><p className="m-0 p-0 text-decoration-underline w-auto" style={{color:"#4EAC6D"}}> Register</p></Link>
          </div>
        </form>
      </div>
    </div>
